...
export function Room(props) {
  const { nodes, materials } = useGLTF(withBase("/models/optimized-room.glb"));
  const screensRef = useRef();
  const matcapTexture = useTexture(withBase("/images/textures/mat1.png"));
...
useGLTF.preload(withBase("/models/optimized-room.glb"));
